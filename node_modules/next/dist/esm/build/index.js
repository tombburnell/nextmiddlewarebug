    ...
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (Object.keys(functionsConfigManifest).length > 0) {
                await fs.writeFile(path.join(distDir, SERVER_DIRECTORY, FUNCTIONS_CONFIG_MANIFEST), JSON.stringify(functionsConfigManifest, null, 2));
            }
            ...
            if (!isGenerate && config.outputFileTracing) {
                ...
                await nextBuildSpan.traceChild("trace-next-server").traceAsyncFn(async ()=>{
                    ...
                    await fs.writeFile(nextServerTraceOutput, JSON.stringify({
                        version: 1,
                        cacheKey,
