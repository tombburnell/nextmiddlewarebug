    ...
    createAsset(assets, compilation, context) {
        ...
        for (const [groupName] of manifestsPerGroup){
            if (groupName.endsWith("/page") || groupName === "app/not-found") {
                ...
                assets["server/" + pagePath + "_" + CLIENT_REFERENCE_MANIFEST + ".js"] = new sources.RawSource(`globalThis.__RSC_MANIFEST=(globalThis.__RSC_MANIFEST||{});globalThis.__RSC_MANIFEST[${JSON.stringify(pagePath.slice("app".length))}]=${JSON.stringify(json)}`);
                if (pagePath === "app/not-found") {
                    // Create a separate special manifest for the root not-found page.
                    assets["server/" + "app/_not-found" + "_" + CLIENT_REFERENCE_MANIFEST + ".js"] = new sources.RawSource(`globalThis.__RSC_MANIFEST=(globalThis.__RSC_MANIFEST||{});globalThis.__RSC_MANIFEST[${JSON.stringify("/_not-found")}]=${JSON.stringify(json)}`);
                }
            }
        }
